<?php
// backoffice/views/fornecedores/create.php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nome_empresa)) {
        ...
        try {
            ...
            $_SESSION['success_msg'] = "Fornecedor actualizado com sucesso!";
            ...
            <div class="card-body bg-light">
                ...
                <form action="edit.php" method="POST">
                    ...
                    <div class="mt-5 text-end border-top pt-4">
                        ...
                        <button type="submit" class="btn btn-primary fw-bold">Alterar Fornecedor</button>
                    </div>
                </form>
